...
import background from "../assets/images/background-hotel.jpg";
...
const ExtractByHotel = () => {
  ...
  return (
    <Box mt="8rem">
        ...
        >
          <Box pt="6.5rem">
            <Typography
              ...
              sx={{ mb: "5px" }}
            >
              Extract all hotels based on Hotel Name or Hotel ID
            </Typography>
          </Box>
          <Box
            mt="4rem"
          ...
          >
            ...
            >
              <InputBase
                ...
                placeholder="Input Hotel Name or Hotel ID"
              />
            </Paper>
            <Button
              sx={{
      ...
      >
        <Box pb="2rem" gridColumn="span 12">
          <Header title="Popular Hotel Searches" />
        </Box>
        <Box
          mt="3rem"
          gridColumn="span 12"
      ...
      >
        <Box pb="2rem" gridColumn="span 12">
          <Header title="Recent Hotel Searches" />
        </Box>
        <Box
          mt="3rem"
          gridColumn="span 12"
